# From https://github.com/dragen1860/MAML-Pytorch/blob/master/learner.py
import torch
import numpy as np
...
class Learner(nn.Module):
    ...
    def forward(self, x, vars=None, bn_training=True):
        ...
        running_mean/running_var. Though weights/bias of bn are updated, it has been separated by fast_weights.
